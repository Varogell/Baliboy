...
use App\Http\Controllers\admiLoginController;
...
Route::Get('/form',[DashboardController::class ,'index'])->middleware('must-admin');
...
//    return view('admin.dashboard', ['type_menu' => 'layout']);
//});
