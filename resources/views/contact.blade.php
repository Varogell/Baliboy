            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2>Contact</h2>
                        <p>Anda bisa menghubungi Logiswift melalui nomor telepon yang tertera pada website resmi kami atau mengisi formulir kontak yang tersedia. Dengan menghubungi Logiswift, Anda bisa mendapatkan informasi lebih lanjut mengenai layanan yang tersedia atau memberikan feedback terkait pengalaman menggunakan jasa Logiswift. Tim customer service yang responsif dan berpengalaman akan siap membantu Anda untuk menjawab segala pertanyaan yang Anda miliki.</p>
                    </div>
                </div>
            </div>
        </div>
